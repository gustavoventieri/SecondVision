...
import { View, StyleSheet, BackHandler,NativeEventEmitter,NativeModules,Platform,
  PermissionsAndroid,TouchableHighlight,SafeAreaView, StatusBar,Text, Pressable,FlatList } from "react-native";
...
export default function BluetoothOnScreen() {
  ...
  const handleDiscoverPeripheral = (peripheral: Peripheral) => {
    ...
    if(peripheral.name === "JBL WAVE BUDS-LE"){
      setPeripherals(map => {
